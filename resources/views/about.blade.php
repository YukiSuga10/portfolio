    ...
    <body>
        <div class="main_content">
            ...
            <main>
                ...
                <section class="main">
                    <img src="./image/me.PNG" width="35%">
    
                    <div class="intro_text">
                        <h6>HAYATO YAGI</h6>
                        <p>アウトドアと”地元”が好きな典型的な沖縄出身ですが、<br> お酒飲めない。<br>
                        刺身好きじゃない。集合時間守る。<br>
                        ガッカリ要素満載のネイティブウチナンチュです。<br>
                        好きな言葉はバランスです。<br>
                        （方言なら、イチャリバチョーデーです。）
                        </p>
                    </div>
                ...
                <div class="main_image">
                    <div class="part">
                        <img src="./image/ps.PNG" width="75%">
                        <p>70%</p>
                    </div>
                    <div class="part">
                        <img src="./image/ai.PNG" width="75%">
                        <p>70%</p>
                    </div>
                    <div class="part">
                        <img src="./image/xd.PNG" width="75%">
                        <p>50%</p>
                    </div>
                    <div class="part">
                        <img src="./image/DW.PNG" width="75%">
                        <p>50%</p>
                    </div>
                </div>
